...
class LogStash::Outputs::Msai
  class Telemetry
    ...
    LOGSTASH_TELEMETRY_INSTRUMENTATION_KEY = "00000000-0000-0000-0000-000000000000"
    ...
    def set_channel_context ( tc )
      tc = ApplicationInsights::TelemetryClient.new( LOGSTASH_TELEMETRY_INSTRUMENTATION_KEY )
